<?php
    ...
    }  else if ($_SESSION['CS_HEAD_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewComputerScience.php';
    $counter = 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $url = $api.'committee/approveComputerScience.php';
        ...
        curl_close($ch);
        echo '<script>window.location.href="approveComputerScience.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['CS_HEAD_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveComputerScience.php" method="POST">
        ...
        <div class="main_screen">
            ...
            <div class="table-container">
                <h1>Computer Science Approval Form</h1>
                    ...
                    <?php } ?>
                        ...
                        <div class="modal" id="modal">
                            ...
                            <h2 class="modal__heading">Confirm</h2>
                                ...
                                <form action="approveComputerScience.php" method="POST">
                                    <input type="hidden" name="student_id" value="<?php echo $_SESSION['CS_HEAD_STUDENT_ID']?>">
