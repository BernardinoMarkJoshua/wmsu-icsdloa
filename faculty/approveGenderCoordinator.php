<?php
    ...
    }  else if ($_SESSION['GENDER_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewGenderCoordinator.php';
    $counter = 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $url = $api.'committee/approveGenderCoordinator.php';
        ...
        curl_close($ch);
        echo '<script>window.location.href="approveGenderCoordinator.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['GENDER_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveGenderCoordinator.php" method="POST">
        ...
        <div class="main_screen">
            ...
            <div class="table-container">
                <h1>Gender & Guidance Coordinator Approval Form</h1>
                <table class="table_achievers">
                    ...
                    <div class="modal" id="modal">
                        ...
                        <h2 class="modal__heading">Confirm</h2>
                            ...
                            <form action="approveGenderCoordinator.php" method="POST">
                                <input type="hidden" name="student_id" value="<?php echo $_SESSION['GENDER_STUDENT_ID']?>">
