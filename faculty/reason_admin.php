<?php 
    ...
    } else if ($_SESSION['STUDENT_DECLINE_STATUS'] != 'yes') {
        echo '<script>window.location.href="viewStudents.php"</script>';
    }
    $_SESSION['STUDENT_DECLINE_STATUS'] = 'no';
    $email = $_SESSION['VIEW_STUDENT_EMAIL_DECLINE'];
    $student_id = $_SESSION['VIEW_STUDENT_ID_DECLINE'];
    $subject= 'Removed from ICS-DLOA';
