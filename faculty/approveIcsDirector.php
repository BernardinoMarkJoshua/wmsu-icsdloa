<?php
    ...
    }  else if ($_SESSION['ICS_DIRECTOR_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewApprovedFinal.php';
    $counter = 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $body = '<h2>Hello '.$student_name.'</h2> <br/> <strong>Your Application form has been approved</strong> <br/> congratulations you have been accepted to the ICS Director\'s List';
        ...
        if ($mail->send()) {
            ...
            curl_close($ch);
            echo '<script>window.location.href="approveIcsDirector.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['ICS_DIRECTOR_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveIcsDirector.php" method="POST">
                    ...
                    <?php } ?>
                        ...
                        <div class="modal" id="modal">
                            ...
                            <h2 class="modal__heading">Confirm</h2>
                                ...
                                <form action="approveIcsDirector.php" method="POST">
                                    <input type="hidden" name="student_id" value="<?php echo $_SESSION['ICS_DIRECTOR_STUDENT_ID']?>">
