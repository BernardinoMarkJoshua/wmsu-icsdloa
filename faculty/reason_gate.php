<?php 
    session_start();
    $email = $_SESSION['GATE_STUDENT_EMAIL_DECLINE'];
    $student_id = $_SESSION['GATE_STUDENT_ID_DECLINE'];
    $subject= 'Application Denied by Adviser';
    ...
    <div class="container" style="margin-top:100px;">
        <div class="row justify-content-center">
            <div class="col-md-6 col-md-offset-3" align="center">
                ...
                <input type="button" data-toggle="modal" data-target="#myModal" id="send-btn" class="btn btn-secondary" value="Send and Decline">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    This student registration will be declined.
                </div>
