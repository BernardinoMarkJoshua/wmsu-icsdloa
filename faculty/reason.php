<?php 
    ...
    } else if ($_SESSION['DECLINE_APPFORM_STATUS'] != 'yes') {
        echo '<script>window.location.href="verify.php"</script>';
    } 
    $_SESSION['DECLINE_APPFORM_STATUS'] = 'no';
    $email = $_SESSION['DECLINE_FORM_STUDENT_EMAIL'];
    $student_id = $_SESSION['DECLINE_FORM_STUDENT_ID'];
