<?php
    ...
    }  else if ($_SESSION['INSTITUTE_SEC_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewSecretary.php';
    $counter = 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $url = $api.'committee/approveSecretary.php';
        ...
        curl_close($ch);
        echo '<script>window.location.href="approveSecretary.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['SECRETARY_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveSecretary.php" method="POST">
        ...
        <div class="main_screen">
            ...
            <div class="table-container">
                <h1>Secretary Approval Forms</h1>
                    ...
                    <?php } ?>
                        ...
                        <div class="modal" id="modal">
                            ...
                            <h2 class="modal__heading">Confirm</h2>
                                ...
                                <form action="approveSecretary.php" method="POST">
                                    <input type="hidden" name="student_id" value="<?php echo $_SESSION['SECRETARY_STUDENT_ID']?>">
