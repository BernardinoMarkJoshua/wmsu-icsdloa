<?php
    ...
    }  else if ($_SESSION['CHAIRPERSON_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewChairperson.php';
    $counter = 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $url = $api.'committee/approveChairperson.php';
        ...
        curl_close($ch);
        echo '<script>window.location.href="approveChairperson.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['CHAIRPERSON_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveChairperson.php" method="POST">
        ...
        <div class="main_screen">
            ...
            <div class="table-container">
                <h1>Chairperson approval Form</h1>
                    ...
                    <?php } ?>
                        ...
                        <div class="modal" id="modal">
                            ...
                            <h2 class="modal__heading">Confirm</h2>
                                ...
                                <form action="approveChairperson.php" method="POST">
                                    <input type="hidden" name="student_id" value="<?php echo $_SESSION['CHAIRPERSON_STUDENT_ID']?>">
