<?php
    ...
    }  else if ($_SESSION['IT_HEAD_STATUS'] != 'yes') {
    ...
    $ch = curl_init();
    $url = $api.'committee/viewInformationTechnology.php';
    $counter= 0;
    ...
    if (isset($_POST['approve'])) {
        ...
        $url = $api.'committee/approveInformationTechnology.php';
        ...
        curl_close($ch);
        echo '<script>window.location.href="approveInformationTechnology.php"</script>';
    ...
    if (isset($_POST['logout'])) {
        ...
        $_SESSION['IT_HEAD_STUDENT_ID'] = $_POST['student_id'];
...
<div class="faculty_container">
        ...
        <div class="side_panel">
            ...
            <div class="navigation">
                ...
                <form action="approveInformationTechnology.php" method="POST">
        ...
        <div class="main_screen">
            ...
            <div class="table-container">
                <h1>Information Technology Approval Forms</h1>
                <table class="table_achievers">
                    ...
                    <?php if ($decoded != 'no students found') { ?>
                        <?php foreach ($decoded as $obj): ?>
                            ...
                            <td><?php echo $obj->firstname.', '.$obj->firstname.' '.$obj->middlename; ?></td>
                    ...
                    <?php } ?>
                        ...
                        <div class="modal" id="modal">
                            ...
                            <h2 class="modal__heading">Confirm</h2>
                                ...
                                <form action="approveInformationTechnology.php" method="POST">
                                    <input type="hidden" name="student_id" value="<?php echo $_SESSION['IT_HEAD_STUDENT_ID']?>">
