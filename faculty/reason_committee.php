<?php 
    ...
    } else if ($_SESSION['COMMITTEE_DECLINE_STATUS'] != 'yes') {
        echo '<script>window.location.href="facultyLanding.php"</script>';
    }

    $email = $_SESSION['COMMITTEE_STUDENT_EMAIL_DECLINE'];
    $student_id = $_SESSION['COMMITTEE_STUDENT_ID_DECLINE'];
    $_SESSION['COMMITTEE_DECLINE_STATUS'] = 'no';
    $subject= 'Application Denied by Committee';
    ...
    <div class="container" style="margin-top:100px;">
        <div class="row justify-content-center">
            <div class="col-md-6 col-md-offset-3" align="center">
                ...
                <input type="button" data-toggle="modal" data-target="#myModal" id="send-btn" class="btn btn-primary" value="Send and Decline">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    The Application form will be declined
                </div>
                   ...
                   data: {
                       ...
                       body: body.val()
                        ...
                        if (response.status == "success")
                            window.location.href = "facultyLanding.php";
                        else {
